...
public class Minicalculadora extends JFrame {
    ...
    private void addOperador(ActionEvent e) {
        JButton button = (JButton) e.getSource();
    ...
    private void cambiarSigno() {
    	...
    	num_actual*=-1;
    	lblMuestra.setText(String.valueOf(num_actual));
    }
    
    private void eliminarDigito() {
    	lblMuestra.setText(lblMuestra.getText().substring(0, lblMuestra.getText().length()-1));
    }
    ...
    private void operar() {
    	...
    	switch(operacion) {
    		case "+":
	    		lblMuestra.setText(String.valueOf(operador1+operador2));
	    		break;
	    	case "-":
	    		lblMuestra.setText(String.valueOf(operador1-operador2));
	    		break;
